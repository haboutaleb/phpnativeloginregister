...
if (isset($_POST['register'])) {
  ...
  if ($validation->run()) {
    ...
    $url      = "http://" . $_SERVER['SERVER_NAME'] . "/hany/confirm.php?confirmation=" . $code;
    $status   = 0;
        ...
        <div class="card">
          <div class="card-body">
            <form action="" method="POST">
              ...
              <div class="form-group">
                <input type="text" name="fullName" class="form-control  " placeholder="Enter Full Name" value="<?php if ($validation->input('fullName')) : echo $validation->input('fullName');
                 endif; ?>">
                <div class="error">
